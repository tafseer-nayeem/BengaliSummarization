...
def summary(sentences):
    compresser = takahe.word_graph(sentences, nb_words = 13, lang = 'bangla', punct_tag = "PUNCT" )
    ...
    reranker = takahe.keyphrase_reranker( sentences,  candidates, lang = 'bangla' )
    ...
    if not pathList:
        compresser = takahe.word_graph(sentences, nb_words = 11, lang = 'bangla', punct_tag = "PUNCT" )
